...
public class Report {
    ...
    public String relatorioQtdAnimais() { // Relatório “Quantidade de animais de cada tipo e categoria”:
        /*
         * O método deve retornar uma String na qual devem aparecer as informações
         * referentes a quantidade de animais para cada tipo e categoria. Exemplo:
         * Carnívoros: PP: 52, MP: 20, GP: 12. Herbívoros: PP: 68, MP: 38, GP: 30.
         */
        String listaFinal = " ";
        int carnivorosPP = 0;
        int carnivorosMP = 0;
    ...
    public Dinossauro relatorioPesoPesado(int tipo, int categoria) { // Relatório “Peso pesado”:
        /*
         * Escreva um método que receba por parâmetro o tipo e categoria de um
         * dinossauro e retorne o dinossauro (objeto) mais pesado do tipo e da
         * categoria.
         */
    ...
    public double relatorioQtdDeCarne() {
        /*
         * Relatório “Quantidade de carne para carnívoros”: Cada carnívoro come um valor
         * relacionado ao seu peso e de acordo com sua categoria. Raças de pequeno porte
         * comem cerca de 10% de seu peso por dia. Raças de médio porte comem cerca de
         * 15% de seu peso por dia. Raças de grande porte comem cerca de 20$ de seu peso
         * por dia. O método deve retornar à quantidade (em Kg) de carne que deve ser
         * comprado no mês (considere o mês por 30 dias).
         */
    ...
    public Dinossauro[] relatorioTop10(Dinossauro vetor[], int tamanho) {
         ...
         * contendo os 10 dinossauros mais velozes ordenados em ordem decrescente de
         * velocidade (maior primeiro).
         */
